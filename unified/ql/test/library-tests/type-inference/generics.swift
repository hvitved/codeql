...
struct StringAssociatedType : SubAssociatedTypeProtocol {
  ...
  // StringAssociatedType.baseValue
  func baseValue() -> String {
    return "base"
  }

  // StringAssociatedType.subValue
  func subValue() -> String {
    return "sub"
  }
}

// getInheritedAssociatedType
func getInheritedAssociatedType<T : SubAssociatedTypeProtocol>(_ value: T) -> T.Value {
  return value.subValue() // $ target=SubAssociatedTypeProtocol.subValue
}

func testInheritedAssociatedType() {
  let value = getInheritedAssociatedType(StringAssociatedType()) // $ type=value:String target=getInheritedAssociatedType
}
...
protocol PrimaryAssociatedTypeProtocol<Element> {
  ...
  // PrimaryAssociatedTypeProtocol.element
...
struct IntPrimaryAssociatedType : PrimaryAssociatedTypeProtocol {
  ...
  // IntPrimaryAssociatedType.element
  func element() -> Int {
    return 42
  }
}

// getPrimaryAssociatedType
func getPrimaryAssociatedType(_ value: some PrimaryAssociatedTypeProtocol<Int>) -> Int {
  return value.element() // $ target=PrimaryAssociatedTypeProtocol.element
}
