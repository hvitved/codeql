...
module Node {
  ...
  final class SourceArgumentNode extends ArgumentNode, ExprNode {
    private CallExprBaseCfgNode call_;
    private RustDataFlow::ArgumentPosition pos_;

    SourceArgumentNode() { isArgumentForCall(n, call_, pos_) }
  ...
  final class SourceReturnNode extends ExprNode, ReturnNode {
    SourceReturnNode() { this.getCfgNode().getASuccessor() instanceof AnnotatedExitCfgNode }
  ...
  final class ArgumentPostUpdateNode extends PostUpdateNode, TArgumentPostUpdateNode {
    private ExprCfgNode n;

    ArgumentPostUpdateNode() { this = TArgumentPostUpdateNode(n) }
